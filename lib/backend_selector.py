...
PIXFARO_SIGNUP_URL = "https://pixfaro.com/signup?ref=linkedin-skills"
...
def _unloaded_token_note() -> str:
    ...
    missing, or the process started elsewhere). Measured 2026-09-15 on Pixfaro's
    side: about half of the keys created by users of this bundle never made a
    single request — and every one of them was told "get a key". Name the file
    and the fix instead of repeating the pitch."""
